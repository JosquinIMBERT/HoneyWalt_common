...
global CMD_VM_PHASE, CMD_VM_WALT_DEVS, CMD_VM_WALT_IPS, CMD_VM_WG_KEYGEN, CMD_VM_WG_DOORS, CMD_VM_WG_UP, CMD_VM_WG_DOWN, CMD_VM_COMMIT, CMD_VM_SHUTDOWN, CMD_VM_LIVE
